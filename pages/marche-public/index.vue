<template>
  <AngeRoot>
    <Head>
      <Title>ANGE-TOGO | Marchés Publics</Title>
      <Meta
        name="description"
        content="Marché public Agence National de Gestion de l'Eenvironnement"
      ></Meta>
    </Head>
    <AngeBreadcrumb
...
.nav-pills .nav-link {
  ...
  flex-direction: row;
  color: black;
  /* Couleur des icônes et du texte inactif */
}
...
.nav-pills .nav-link.active {
  ...
  color: white;
  /* Couleur des icônes et du texte actif */
}
...
@media (min-width: 768px) {
  ...
  .nav-item {
    margin-bottom: 35px; /* Ajouter de l'espace entre les éléments */
  }
