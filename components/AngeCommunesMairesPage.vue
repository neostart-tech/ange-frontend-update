        ...
        <div class="download-content">
          <div class="download-info">
            ...
            <div class="file-details">
              ...
              <p>
                Document détaillé contenant la liste officielle des communes et leurs
                maires
              </p>
            </div>
          </div>
                  ...
                  <tr>
                    <th class="col-numero">
                      <div class="column-header">
                        ...
                        >
                          <path
                            d="M4 17v2h16v-2H4zM4 5v2h16V5H4zm10 7V9h-4v3H8l4 4 4-4h-2z"
                          />
                        </svg>
                        N°
                      </div>
        ...
        <div class="mobile-view">
          <div class="mobile-cards">
            <div
              ...
              :key="'mobile-' + commune.id"
              class="commune-card"
            >
              <div class="card-header">
                <div class="numero-badge-mobile">
                  <span>{{ commune.id }}</span>
                </div>
