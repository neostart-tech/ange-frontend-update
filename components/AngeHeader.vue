<template>
  <div>
    ...
    <div
      ...
      :class="{ 'is-sticky header-transparent': isSticky }"
    >
            ...
            <div class="col-xl-2 col-auto order-0">
              <div class="header-logo">
                <NuxtLink to="/">
                  <img
                    class="dark-logo"
                    src="/images/logo/logo-ANGE.png"
                    alt="Agency Logo"
                    style="max-width: 0px;font-weight: 700;font-size: 16px;line-height: 120%;"
                  /> <span style="color: #054258;">ANGE</span>
                  <img
                    class="light-logo"
                    src="/images/others/armoirie.png"
                    alt="Agency Logo"
                  />
                </NuxtLink>
              </div>
...
<!--                </div>-->
              ...
              <div
                class="header-mobile-menu-toggle d-xl-none ml-sm-2"
            ...
            >
              <NuxtLink to="/">
                <img
                  src="/images/others/Blason-rt.jpg"
                  alt="Agency Logo"
