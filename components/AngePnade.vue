      ...
      <div class="tab-content-wrapper">
        <transition :name="transitionName" mode="out-in">
          <div 
            ...
            class="tab-content"
          >
            <!-- Onglet 1 : À propos du PNADE -->
            <div v-if="activeTab === 0">
              <Angeapropospnade/>
            </div>

            <!-- Onglet 2 : Résultats CNCE -->
            <div v-else-if="activeTab === 1">
              <AngeResultatCNCE/>
            </div>

            <!-- Onglet 3 : Résultats GESTER -->
            <div v-else-if="activeTab === 2">
              <AngeResultatGESTER/>
            </div>

            <!-- Onglet 4 : Résultats PIT -->
...
const tabs = ref([
  {
    title: "À propos du PNADE",
    completed: false
  },
  {
    title: "Résultats CNCE",
    completed: false
  },
  {
    title: "Résultats GESTER",
    completed: false
  },
  {
    title: "Résultats PIT",
