<template>
  <div class="container">
    <!-- Système de tabulation identique à l'autre -->
      ...
      <div class="tab-content-wrapper">
        <transition :name="transitionName" mode="out-in">
          ...
          >
            ...
            <div v-if="activeTab === 0" class="tab-pane active">
...
// Mêmes 6 onglets mais affichés dans 3 positions comme l'autre
const tabs = ref([
  {
...
// Fonctions identiques à l'autre composant
const checkMobile = () => {
...
/* Correction pour l'affichage du contenu */
.tab-pane {
  opacity: 1 !important;
  transform: none !important;
}
...
/* Debug styles - à retirer en production si tout fonctionne */
.debug-tab {
