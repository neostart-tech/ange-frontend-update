    ...
    <div class="container">
      ...
      <div class="table-section">
        ...
        <div v-else-if="errorBureaux" class="error">
          <i class="fas fa-exclamation-triangle"></i> Erreur de chargement des bureaux
          d'études
        </div>
      ...
      <div class="download-section">
        <a :href="document.path" class="download-btn" download>
...
export default {
  data() {
    return {
      ...
      // Document des consultant a télécharger
      document: [] || "/pdf/LISTES DES CONSULTANTS & BUREAUX D'ETUDES.pdf",
