                        ...
                        <thead>
                            <tr>
                                <th colspan="3" class="table-main-title">
                                    3. Coûts de délivrance des autorisations environnementales  
                                </th>
                            </tr>
                            <tr>
                                <th>Numéro</th>
                                <th>Désignation</th>
                                <th> Montant de référence</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr v-for="(coutDelivrance, index) in coutDelivrances" :key="index">
                                <td>{{ coutDelivrance.numero }}</td>
                                <td>{{ coutDelivrance.designation }}</td>
                                <td>{{ coutDelivrance.montant_reference }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
